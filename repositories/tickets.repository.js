...
module.exports = {
    ...
    addTicket: async (ticket) => db.query('INSERT INTO ticket (session_id, seat, user_id, price, seller_id) VALUES ($1, $2, $3, $4, $5)', [ticket.session_id, ticket.seat, ticket.user_id, ticket.price, ticket.seller_id])
}
